...
const int redLED = 6;              // Status LED
const int greenLED = 7;            // Status LED

int redBtnStatus, greenBtnStatus;
...
void loop() {
//  redBtnStatus = digitalRead(redBtn);
//  greenBtnStatus = digitalRead(greenBtn);
//  Serial.print("Red Btn Status: ");
//  Serial.print(redBtnStatus);
//  Serial.print(" Green Btn Status: ");
//  Serial.println(greenBtnStatus);
//  if (redBtnStatus == HIGH && greenBtnStatus == LOW){
//    openDoor();
//  }
//  if (redBtnStatus == LOW && greenBtnStatus == HIGH){
//    closeDoor();
//  }
